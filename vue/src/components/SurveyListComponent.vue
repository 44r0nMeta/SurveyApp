<template>
  ...
  >
    ...
    <div v-html="survey.description?.substr(0,213)" class="overflow-hidden flex-1"></div>
    <div class="flex justify-between items-center mt-3">
      <router-link
        ...
        "
        :to="{ name: 'showSurvey', params: { id: survey.id } }"
      >
        Edit &nbsp;
        <svg
        ...
        >
          ...
          >
            ...
            >
              ...
              />
              <path
                d="m7.5.5h-5c-1.1045695 0-2 .8954305-2 2v10c0 1.1045695.8954305 2 2 2h11c1.1045695 0 2-.8954305 2-2v-4"
              />
            </g>
          </svg>
        </a>
